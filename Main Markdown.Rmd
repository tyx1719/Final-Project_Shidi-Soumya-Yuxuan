...
reg1 <- lm(ds4$Emission.diesel~ds4$Quantity.diesel)
summary(reg1)

reg2 <- lm(ds4$Emission.gas~ds4$Quantity.gas)
summary(reg2)
#Question here, I don't whether it is appropriate to use regression here, maybe use some cross group comparison
