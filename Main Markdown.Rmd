...
ggplot(Master_table_vehicles, aes(x=Year,y=Heavy,group=Fuel_Type,color=Fuel_Type))+
  geom_point()+
  geom_line()+
  xlab("Year")+
  ylab("Heavy Vehicle Quantity")+
  theme(legend.position = "right")+
  labs(color="Type of vehicles")

#Light vehicle trend over time
ggplot(Master_table_vehicles, aes(x=Year,y=Light,group=Fuel_Type,color=Fuel_Type))+
  geom_point()+
  geom_line()+
  xlab("Year")+
  ylab("Light Vehicle Quantity")+
  theme(legend.position = "right")+
  labs(color="Type of vehicles")
Master_table_vehicles
