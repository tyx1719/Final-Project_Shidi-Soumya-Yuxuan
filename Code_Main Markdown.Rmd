...
#NOX.gas
colnames(NOX.gas) <- c("Year","LDA","LDT1","LDT2","MDV","LHDGTI1","LHDGTI1","MHDGT","HHDGT", "MCY", "UBG","SBG", "OBG", "MH")
...
#COT.gas
colnames(COT.gas) <- c("Year","LDA","LDT1","LDT2","MDV","LHDGTI1","LHDGTI1","MHDGT","HHDGT", "MCY", "UBG","SBG", "OBG", "MH")
...
#NOX.light
colnames(NOX.light) <- c("Year","LDA","LDT1","LDT2","MDV","MCY","SBG","SBD","OBG", "OBC", "OBD","MH")
...
#COT.light
colnames(COT.light) <- c("Year","LDA","LDT1","LDT2","MDV","MCY","SBG","SBD","OBG", "OBC", "OBD","MH")
...
#NOX.heavy
colnames(NOX.heavy) <- c("Year","LHDGT1","LHDGT2","MHDGT","HHDGT","LHDDT1","LHDDT2","MHDDT","HHDDT", "UBD", "UBG")
...
#COT.heavy
colnames(COT.heavy) <- c("Year","LHDGT1","LHDGT2","MHDGT","HHDGT","LHDDT1","LHDDT2","MHDDT","HHDDT", "UBD", "UBG")
